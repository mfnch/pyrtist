...
typedef struct _BoxVMX_struct BoxVMX;
...
typedef struct {
  ...
  void (*get_args)(BoxVMX *);        /**< Per trattare gli argomenti */
  void (*execute)(BoxVMX *);         /**< Per eseguire l'istruzione */
  void (*disasm)(BoxVMX *, char **); /**< Per disassemblare gli argomenti */
} BoxVMInstrDesc;
...
struct _BoxVMX_struct {
  ...
  BoxValue    buf[2];     /**< Buffer used to pass values around */
  int         buf_pos;    /**< Position in buffer */
...
void VM__D_GLPI_GLPI(BoxVMX *vmx, char **iarg);
void VM__D_CALL(BoxVMX *vmx, char **iarg);
void VM__D_JMP(BoxVMX *vmx, char **iarg);
void VM__D_GLPI_Imm(BoxVMX *vmx, char **iarg);
