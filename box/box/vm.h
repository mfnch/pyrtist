...
typedef enum {
  ...
  BOXOP_ADD_II, BOXOP_ADD_RR, BOXOP_ADD_PP, BOXOP_ADD_OO,
  ...
  BOXOP_TYPEOF_I, BOXOP_NOTNUL_O,
  BOXOP_BOX_O, BOXOP_BOX_OO, BOXOP_WBOX_OO, BOXOP_UNBOX_O,
  BOXOP_DYCALL_OO,
  BOX_NUM_OPS
} BoxOpId;
...
typedef enum {
  ...
  BOXGOP_TYPEOF, BOXGOP_NOTNUL, BOXGOP_BOX, BOXGOP_WBOX, BOXGOP_UNBOX,
  BOXGOP_DYCALL,
  BOX_NUM_GOPS
} BoxGOp;
