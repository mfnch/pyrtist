...
static void My_Exec_Pow_II(BoxVMX *vmx) { /* bad implementation!!! */
  BoxInt i, r = 1, b = *((BoxInt *) vmx->arg1.ptr),
         p = *((BoxInt *) vmx->arg2.ptr);
  for (i = 0; i < p; i++) r *= b;
