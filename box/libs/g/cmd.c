...
BoxGCmdSig BoxGCmdSig_Get(BoxGCmd cmd_id) {
  static struct cmd_signature_s {
    ...
    {BOXGCMD_PATTERN_CREATE_IMAGE, BOXGCMDSIG_PPPS},
    ...
    {BOXGCMD_EXT_SET_AUTO_BBOX, BOXGCMDSIG_I},
    {BOXGCMD_EXT_UNSET_BBOX, BOXGCMDSIG_NONE},
    ...
    {BOXGCMD_EXT_DRAW_PICTURE, BOXGCMDSIG_S}
  };
