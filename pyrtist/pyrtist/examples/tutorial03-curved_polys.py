...
p1 = Point(2.85237428571, 48.1543624161); bbox2 = Point(100.0, 12.5838926174)
p4 = Point(26.6937557447, 38.1285583893); bbox1 = Point(0.0, 50.0)
...
'''
  ...
  Text[p1, font, From[(0, 1)], color.red
    "From version 0.4.0, Boxer allows creating curves (cubic Bezier splines)."
    "\nThis example explains how."]

  s = "             "
  Text[p2, font, From[(0, 1)]
    "STEP 1: launch Boxer or create a new document (CTRL+N)\n"
    "STEP 2: click on the icon       to create a new curved polygon\n"
